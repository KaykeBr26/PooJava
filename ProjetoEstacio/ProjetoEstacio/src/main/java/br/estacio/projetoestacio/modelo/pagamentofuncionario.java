...
public class pagamentofuncionario {
    ...
    public pagamentofuncionario(Integer codigo, String nomeFuncionario, String CPFuncionario, String horasTrabalhadas, String VoosfeitosMês, String TelefoneFuncionario, String pagamento, String dataPagamento) {
        this.codigo = codigo;
    ...
    public String toString() {
        return "pagamentofuncionario{" + "codigo=" + codigo + ", nomeFuncionario=" + nomeFuncionario + ", CPFuncionario=" + CPFuncionario + ", horasTrabalhadas=" + horasTrabalhadas + ", VoosfeitosM\u00eas=" + VoosfeitosMês + ", TelefoneFuncionario=" + TelefoneFuncionario + ", pagamento=" + pagamento + ", dataPagamento=" + dataPagamento + '}';
    }
